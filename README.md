...
`develop` builds both OpenSearch lines; the OpenSearch version you pass selects the line:

| OpenSearch line | Supported versions | Java |
| --- | --- | --- |
| 2.x | `2.15.0`, `2.17.0`, `2.19.0` | 11 |
| 3.x | `3.1.0`, `3.3.0`, `3.5.0`, `3.6.0` | 21 |
